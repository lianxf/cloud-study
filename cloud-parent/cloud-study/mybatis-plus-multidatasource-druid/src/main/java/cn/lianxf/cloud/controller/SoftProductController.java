...
public class SoftProductController {
    ...
    @GetMapping("/plist")
    public List<SoftProduct> get() {
        LambdaQueryWrapper<SoftProduct> wrapper = new LambdaQueryWrapper<>();
        wrapper.eq(SoftProduct::getFlowInstId, "123123");
        return softProductMapper.findByFlowInstId("123123");
    }
}
