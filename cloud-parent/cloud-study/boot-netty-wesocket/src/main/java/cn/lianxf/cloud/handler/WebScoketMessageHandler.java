...
/**
 * @className WebScoketMessageHandler
 * @description websocket消息处理
 * @date 2021/9/11 下午2:35
 * @author little
 * @version 1.0.0
 */
@Slf4j
public class WebScoketMessageHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
